...
if __name__ == '__main__':
    ...
    rgb_video_name = '0001.M.avi'
    index = len(rgb_video_name)-5
    depth_video_name = rgb_video_name[0:index]+'K.avi'
    print rgb_video_name, depth_video_name, '\n'
    # capture
    output_video_path = root_save_path + '/' + rgb_video_name[0:index] + 'M_detect.avi'
